        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Button variant="outline" asChild className="rounded-full">
              <a href="https://github.com/Seifeldin-Sabry" target="_blank" className="flex items-center gap-2">
                <Github size={18} /> GitHub
              </a>
            </Button>
            <Button variant="outline" asChild className="rounded-full">
              <a href="https://www.linkedin.com/in/seifeldin-sabry-b8a542202/" target="_blank" className="flex items-center gap-2">
